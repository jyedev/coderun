...
public class AdminPaymentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map<String, Object> returnMap = adminService.selectPaymentList(pageNo, searchMap);
		
		System.out.println("paymentList : " + returnMap.get("peymentList"));
		System.out.println("selectCriteria : " + returnMap.get("selectCriteria"));
		
		String path = "";
		if(returnMap.get("paymentList") != null && returnMap.get("selectCriteria") != null) {
			path = "/WEB-INF/views/admin/payment.jsp";
			request.setAttribute("paymentList", returnMap.get("paymentList"));
