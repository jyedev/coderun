...
<jsp:include page="../common/menubar.jsp"/>
    <section>
        <div class="mx-auto writeform">
            <h2 class="mb-3 border-bottom">신고글 작성<br><br></h2>
            <br><br>
            <form class="needs-validation" method="post" action="${ pageContext.servletContext.contextPath }/report/insert" validate>
                <div class="writesubmit row g-3">
                    <div class="titletextbox col-sm-6">
                        <label for="firstName" class="form-label"><strong>${ report.memberId }</strong></label>
                        <input type="text" name="title" class="form-control" id="firstName" placeholder="제목 입력" required>
