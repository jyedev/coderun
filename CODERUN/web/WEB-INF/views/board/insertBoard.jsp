...
<jsp:include page="../common/menubar.jsp"/>
    <section>
        <div class="mx-auto writeform">
            <h2 class="mb-3 border-bottom">게시글 작성<br><br></h2>
            <br><br>
            <form class="needs-validation" method="post" action="${ pageContext.servletContext.contextPath }/board/insert" validate>
